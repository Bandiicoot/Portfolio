function carrusel(el) {
  ...
  <body>
  <div class="contenedor-interactua">
  <h3 class="subtitulo-interactua">Arrastrá con el mouse e interactua libremente !</h3>
  </div>
  <div class="contenedor-ruleta">
    ...
    <div id="drag-container">
      <div id="spin-container">
        <img
          src="./imgs/ppt-online.png"
          alt=""
          class="bandicoot__img"
        />
    
        <img
        src="./imgs/pet-finder.png"
        alt=""
        class="foto2"
      />

      <img
        src="./imgs/buscador.png"
        alt=""
        class="foto3"
      />

      <img
        src="./imgs/ppt-singleplayer.png"
        alt=""
        class="foto4"
      />
...
<!-- </template>  -->
  ...
  bandi.addEventListener("click", () => {
    ...
    ass.target = "_blank";
    ass.href =
      "https://www.linkedin.com/feed/update/urn:li:activity:7125563752590028800/";
    ass.click();
  ...
  foto3.addEventListener("click", () => {
    ...
    ass.target = "_blank";
    ass.href =
      "https://www.linkedin.com/feed/update/urn:li:activity:7123801141653516288/";
    ass.click();
  });
  ...
  foto4.addEventListener("click", () => {
    ...
    ass.target = "_blank";
    ass.href =
      " https://www.linkedin.com/feed/update/urn:li:activity:7123752581679489024/";
    ass.click();
  });
}
